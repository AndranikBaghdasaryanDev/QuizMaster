...
export const Mail = () => {
	return <>
		...
		<main className=" text-white font-sans">
			...
			<SectionAbout/>
			<section className="flex justify-center items-center bg-black py-20 px-6">
				<div className="w-full max-w-6xl flex flex-col md:flex-row justify-between items-center gap-10 bg-gradient-to-r from-[#6B21A8] via-[#9333EA] to-[#C2410C] rounded-3xl p-10 md:p-14 shadow-xl">
					...
					<div className="flex-1 flex justify-center md:justify-end">
						<div className="bg-white rounded-2xl w-[280px] h-[180px] md:w-[340px] md:h-[220px] shadow-lg"></div>
					</div>
				</div>
			</section>
		</main>
